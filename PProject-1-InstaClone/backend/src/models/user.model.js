...
const userSchema = new mongoose.Schema({
  ...
  password: {
    ...
    //! To make it unreadable in populate, but it will give undefined in login where we need password to compare so we will handle it there
    select: false,
  },
  bio: String,
  profileImage: {
    type: String,
    default: "https://ik.imagekit.io/vclk2b3f9/male-face-icon-default-profile-image--c3f2c592f9.jpg",
  },
